...
zf = zipfile.ZipFile(r"C:/Users/Pupul/Desktop/world.kmz",'r')
for fn in zf.namelist():
    if fn.endswith('.kml'):
        content = zf.read(fn)
        xmldoc = minidom.parseString(content)
        out_name = 'C:/Users/Pupul/Desktop/world.kml'
        out = open(out_name,'w')
        out.writelines(xmldoc.toxml())
        out.close()
    else:
        print("no kml file")
tree= ET.parse('C:/Users/Pupul/Desktop/world.kml')
root= tree.getroot()
with open("C:/Users/Pupul/Desktop/world.csv","w",newline='') as f_file,open("C:/Users/Pupul/Desktop/worldnn.csv", "w",newline='') as fp_out,open("C:/Users/Pupul/Desktop/world.csv","r") as re_file:
...
df=pd.read_csv('C:/Users/Pupul/Desktop/world.csv',dtype={'lon': np.float64,'lat':np.float64})
...
plt.xlabel("lon")
plt.ylabel("lat")
fname='C:/Users/Pupul/Desktop/ff.pdf'
plt.savefig(fname)
